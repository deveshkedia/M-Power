...
lung_image_model = keras.models.load_model("/Users/deveshkedia/Desktop/Development/Projects/Doing/M-Power/DiseaseDetection/Models/lung-image.hdf5")
...
def brest_cancer(request):
  if request.method == "POST":
    ...
    if pred == 1 :
      result = "You have been diagnosed with the brest cancer. We advise you to consult a doctor."
    else:
